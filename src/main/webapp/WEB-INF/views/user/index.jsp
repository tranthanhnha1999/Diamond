			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a  href="product_details.html"
							title="add to cart"><span "></span></a> <img
							src="<c:url value="/assets/user/img/day-chuyen-2.jpg" />"
				...
				<li>
					<div class="thumbnail">
						<a  href="product_details.html"
							title="add to cart"><span ></span></a> <img
							src="<c:url value="/assets/user/img/dong-ho2.jpg" />"
				...
				<li>
					<div class="thumbnail">
						<a  href="product_details.html"
							title="add to cart"><span "></span></a> <img
							src="<c:url value="/assets/user/img/nhan-kim-cuong-3.jpg" />"
