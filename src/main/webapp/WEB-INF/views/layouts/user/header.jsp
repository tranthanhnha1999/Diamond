	...
	<div class="row">
		<div class="span4">
			<h1>
				<a class="logo" href="<c:url value="/trang-chu"/>"><span>Twitter Bootstrap
					...
					src="<c:url value="/assets/user/img/I'm dreaming of a (1).png" />"
		...
		<div class="span4">
			<div class="offerNoteWrapper">
				<h1 class="dotmark">
					<i class="icon-cut"></i> Thương hiệu trang sức kim cương cao cấp dẫn đầu với trải nghiệm dịch vụ chuyên nghiệp khác biệt.
				</h1>
			</div>
		</div>
		<div class="span4 alignR">
			<p>
				<br> <strong> Hổ trợ tư vấn (24/7) : 0909 090 909 </strong><br>
				<br>
			</p>
