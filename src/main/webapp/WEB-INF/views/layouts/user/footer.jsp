...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/hublot.png" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/logo_ngoclan.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
		...
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/logo_3.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/Jaeger-leCoultre-logo.png" />"></a>
		</div>
	</div>
</section>
